 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/** Operation to call {@link opencv_core#multiply} */
public class Multiply implements CVOperation {
    ...
    public String getDescription() {
        return "Calculate the per-pixel scaled product of two images.";
    }
    ...
    public void perform(InputSocket<?>[] inputs, OutputSocket<?>[] outputs) {
        ...
        try {
            opencv_core.multiply(src1, src2, dst, scale, -1);
