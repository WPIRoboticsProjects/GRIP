 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/** Operation to call {@link opencv_core#absdiff} */
public class Absdiff implements CVOperation {
    ...
    public String getDescription() {
        return "Calculate the per-element absolute difference of two images.";
    }
    ...
    public void perform(InputSocket<?>[] inputs, OutputSocket<?>[] outputs) {
        ...
        try {
            opencv_core.absdiff(src1, src2, dst);
