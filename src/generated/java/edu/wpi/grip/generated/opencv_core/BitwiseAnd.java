 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/** Operation to call {@link opencv_core#bitwise_and} */
public class BitwiseAnd implements CVOperation {
    ...
    public String getDescription() {
        return "Calculate the per-element bitwise conjunction of two images.";
    }
    ...
    public void perform(InputSocket<?>[] inputs, OutputSocket<?>[] outputs) {
        ...
        try {
            opencv_core.bitwise_and(src1, src2, dst);
