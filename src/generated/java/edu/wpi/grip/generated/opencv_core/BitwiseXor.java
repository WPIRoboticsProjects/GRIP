 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/** Operation to call {@link opencv_core#bitwise_xor} */
public class BitwiseXor implements CVOperation {
    ...
    public String getDescription() {
        return "Calculate the per-element bit-wise \"exclusive or\" on two images.";
    }
    ...
    public void perform(InputSocket<?>[] inputs, OutputSocket<?>[] outputs) {
        ...
        try {
            opencv_core.bitwise_xor(src1, src2, dst);
