 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/** Operation to call {@link opencv_core#bitwise_or} */
public class BitwiseOr implements CVOperation {
    ...
    public String getDescription() {
        return "Calculate the per-element bit-wise disjunction of two images.";
    }
    ...
    public void perform(InputSocket<?>[] inputs, OutputSocket<?>[] outputs) {
        ...
        try {
            opencv_core.bitwise_or(src1, src2, dst);
