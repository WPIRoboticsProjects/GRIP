 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/** Operation to call {@link opencv_imgproc#dilate} */
public class Dilate implements CVOperation {
    ...
    public String getDescription() {
        return "Expands areas of higher values in an image.";
    }
    ...
    public void perform(InputSocket<?>[] inputs, OutputSocket<?>[] outputs) {
        ...
        try {
            opencv_imgproc.dilate(src, dst, kernel, anchor, iterations, borderType.value, borderValue);
