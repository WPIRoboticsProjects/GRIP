...
public enum MorphShapesEnum {
    ...
    MORPH_RECT(opencv_imgproc.MORPH_RECT), /** a cross-shaped structuring element:
 *  \f[E_{ij} =  \fork{1}{if i=\texttt{anchor.y} or j=\texttt{anchor.x}}{0}{otherwise}\f] */
    MORPH_CROSS(opencv_imgproc.MORPH_CROSS), /** an elliptic structuring element, that is, a filled ellipse inscribed
