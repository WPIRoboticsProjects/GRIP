...
/**
 * A JavaFX shape that renders itself as a curve connecting two sockets.  This is used to show when
 * outputs are connected to which inputs between different steps in the pipeline.a
 */
public class ConnectionView extends CubicCurve {

  private final Connection connection;
  private final ObjectProperty<Point2D> outputHandle = new SimpleObjectProperty<>(this,
      "outputHandle", new Point2D(0.0, 0.0));
  private final ObjectProperty<Point2D> inputHandle = new SimpleObjectProperty<>(this,
      "inputHandle", new Point2D(0.0, 0.0));
