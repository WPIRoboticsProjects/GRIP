...
public final class PreviousNextButtons extends SegmentedButton {
    ...
    private static final Image
            nextImage = new Image(CameraSourceController.class.getResourceAsStream("/edu/wpi/grip/ui/icons/next.png")),
            previousImage = new Image(CameraSourceController.class.getResourceAsStream("/edu/wpi/grip/ui/icons/previous.png"));
