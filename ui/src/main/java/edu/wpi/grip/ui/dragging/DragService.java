...
/**
 * A service to provide data transfer capabilities between two controllers. Concrete versions of the
 * service are usually {@link com.google.inject.Singleton Singletons} so that they can be injected
 * into the two controllers.
 *
