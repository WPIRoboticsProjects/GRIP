...
/**
 * A JavaFX control that renders information about an {@link Operation}.  This is used in the
 * palette view to present the user with information on the various operations to choose from.
 */
...
public class OperationController implements Controller {
  ...
  protected void initialize() {
    ...
    root.setOnDragDetected(mouseEvent -> {
      ...
      operationDragService.beginDrag(operationMetaData, root, operationMetaData.getDescription()
          .name());
      mouseEvent.consume();
    });
