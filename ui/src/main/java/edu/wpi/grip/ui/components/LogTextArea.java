...
/**
 * A text area that is used to display a log. Implements the ability to pause scrolling and the
 * protection of not causing the JavaFX thread to hang if the string becomes too long.
 *
...
public class LogTextArea extends TextArea {
  ...
  /**
   * Adds a line to the log. This will keep track of the scroll position and maintain the scroll
   * position if scrolling is paused.
   *
