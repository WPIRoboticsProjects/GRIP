...
public class CVRectangleTest extends AbstractGenerationTest {
  private final double x0 = 20;
  private final double y0 = 40;
  private final double x1 = 100;
  private final double y1 = 120;
  private final double thickness = 2;
  private final double shift = 3;
  ...
  void validate(PipelineInterfacer pip) {
    ...
    assertFalse("Pipeline output is empty", ((org.bytedeco.javacpp.opencv_core.Mat) out.get())
        .empty());
    Mat genMat = (Mat) pip.getOutput("CV_Rectangle0Output0", GenType.IMAGE);
