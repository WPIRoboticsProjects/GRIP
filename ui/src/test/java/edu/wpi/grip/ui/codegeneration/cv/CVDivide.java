...
public class CVDivide extends AbstractGenerationTest {
  ...
  public void cvDivideTest() {
    test(() -> setup(), (pip) -> validate(pip), "CvDivideTest");
  }
  ...
  void validate(PipelineInterfacer pip) {
    ...
    pip.process();
    Mat genMat = (Mat) pip.getOutput("CV_Divide0Output0", GenType.IMAGE);
