...
public class ExceptionWitnessResponderButtonTest extends ApplicationTest {
  ...
  public void start(Stage stage) {
    ...
    final ExceptionWitnessResponderButton button = new ExceptionWitnessResponderButton(witnessed,
        "Test Button Popover");
  ...
  public void testOnExceptionEvent() throws Exception {
    ...
    WaitForAsyncUtils.waitFor(2, TimeUnit.SECONDS,
        () -> NodeMatchers.isVisible().matches(lookup("." + ExceptionWitnessResponderButton
            .STYLE_CLASS).query()));
  }
  ...
  public void testOnExceptionClearedEvent() throws Exception {
    ...
    WaitForAsyncUtils.waitFor(2, TimeUnit.SECONDS,
        () -> NodeMatchers.isInvisible().matches(lookup("." + ExceptionWitnessResponderButton
            .STYLE_CLASS).query()));
  }
  ...
  public void testPopoverAppears() throws TimeoutException {
    ...
    WaitForAsyncUtils.waitFor(2, TimeUnit.SECONDS,
        () -> NodeMatchers.isVisible().matches(lookup("." + ExceptionWitnessResponderButton
            .ExceptionPopOver.STYLE_CLASS).query()));
  }
  ...
  private void flagNewException() {
    try {
      ...
      witness.flagException(e, "An Illegal Message that is really, really, really, really, "
