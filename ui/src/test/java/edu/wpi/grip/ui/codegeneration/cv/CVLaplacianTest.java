...
public class CVLaplacianTest extends AbstractGenerationTest {
  private final double ksize = 5;
  ...
  void validate(PipelineInterfacer pip) {
    ...
    assertFalse("Pipeline output is empty", ((org.bytedeco.javacpp.opencv_core.Mat) out.get())
        .empty());
    Mat genMat = (Mat) pip.getOutput("CV_Laplacian0Output0", GenType.IMAGE);
