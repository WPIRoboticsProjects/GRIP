...
public class CVBitwiseAnd extends AbstractGenerationTesting {
  ...
  public void cvBitwiseAndTest() {
    test(() -> set(), (pip) -> validate(pip), "CvBitwiseAndTest");
  }
  ...
  void validate(PipelineInterfacer pip) {
    ...
    pip.process();
    Mat genMat = (Mat) pip.getOutput("CV_Bitwise_And0Output0", GenType.IMAGE);
