...
public class CVMedianBlurTest extends AbstractGenerationTest {
  ...
  public void medianBlurTest() {
    test(() -> setup(), (pip) -> validate(pip), "medianBlurTest");
  }
  ...
  void validate(PipelineInterfacer pip) {
    ...
    assertFalse("Pipeline output is empty", ((org.bytedeco.javacpp.opencv_core.Mat) out.get())
        .empty());
    Mat genMat = (Mat) pip.getOutput("CV_MedianBlur0Output0", GenType.IMAGE);
