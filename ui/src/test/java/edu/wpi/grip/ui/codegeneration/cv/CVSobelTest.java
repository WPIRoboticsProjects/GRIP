...
public class CVSobelTest extends AbstractGenerationTest {
  private final double dx = 1;
  private final double dy = 1;
  private final double ksize = 3;
  private final double scale = 10;
  private final double delta = 100;
  ...
  void validate(PipelineInterfacer pip) {
    ...
    assertFalse("Pipeline output is empty", ((org.bytedeco.javacpp.opencv_core.Mat) out.get())
        .empty());
    Mat genMat = (Mat) pip.getOutput("CV_Sobel0Output0", GenType.IMAGE);
