...
public class PythonTest {
  ...
  public void testPythonAdditionFromString() throws Exception {
    PythonScriptFile pythonScriptFile = PythonScriptFile.create(
        "import edu.wpi.grip.core.sockets as grip\nimport java.lang.Integer\n\nname = \"Addition "
            ...
            + ".SocketHints.createNumberSocketHint(\"b\", 0.0),\n]\n\n"
  ...
  public void testDefaultName() throws Exception {
    OperationDescription additionDescription = PythonScriptFile.create(PythonTest.class
        .getResource("/edu/wpi/grip/scripts/addition.py"))
  ...
  public void testName() throws Exception {
    OperationDescription additionDescription = PythonScriptFile.create(PythonTest.class
        .getResource("/edu/wpi/grip/scripts/addition-with-name-and-description.py"))
        .toOperationMetaData(isf, osf).getDescription();
  ...
  public void testSummary() throws Exception {
    OperationDescription additionDescription = PythonScriptFile.create(PythonTest.class
        .getResource("/edu/wpi/grip/scripts/addition-with-name-and-description.py"))
        .toOperationMetaData(isf, osf).getDescription();
    assertEquals("Description incorrect", "Compute the sum of two integers", additionDescription
        .summary());
  }
