...
public class HttpSourceTest {
    ...
    public void testPostImage() throws IOException {
        ...
        assertTrue("The value should now be present after POSTing the image", imageSource.getValue().get().empty());
    }
    ...
    private void doPost(String path, File imageFile) throws IOException {
        ...
        // POST will hang if timeouts aren't given
