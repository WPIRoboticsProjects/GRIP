...
public class LinkedSocketHintTest {
  ...
  public void testConnectingAnyType() {
    ...
    assertTrue("Boolean should be compatible with linkedSocketHint", linkedSocketHint
        .isCompatibleWith(booleanSocketHint));
    assertTrue("Number should be compatible with linkedSocketHint", linkedSocketHint
        .isCompatibleWith(numberSocketHint));
  }
  ...
  public void testMakingConnectionOfTypeBooleanPreventsConnectionOfTypeNumber() {
    ...
    // Then
    assertFalse("Linked Socket Hint should no longer support number types", linkedSocketHint
        .isCompatibleWith(numberSocketHint));
    assertTrue("Linked Socket Hint should still accept boolean types", linkedSocketHint
        .isCompatibleWith(booleanSocketHint));
  }
}
