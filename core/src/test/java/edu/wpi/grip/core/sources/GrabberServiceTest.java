...
public class GrabberServiceTest {
  ...
  public void testStartUpRethrowsConstructorException() throws GrabberService
      .GrabberServiceException {
    try {
      final GrabberService grabberService =
          createSimpleGrabberService(ConstructorThrowingFrameGrabber::new);
  ...
  @Test(expected = GrabberService.GrabberServiceException.class)
  public void testRunOnceThrowsExceptionWhenGrabThrowsException() throws GrabberService
      .GrabberServiceException {
  ...
  @Test(expected = GrabberService.GrabberServiceException.class)
  public void testRunOnceThrowsExceptionWhenNullFrameIsReturned() throws GrabberService
      .GrabberServiceException {
    try {
      final GrabberService grabberService = createSimpleGrabberService(
          () -> new SimpleMockFrameGrabber() {
  ...
  @Test(expected = GrabberService.GrabberServiceException.class)
  public void testRunOnceThrowsExceptionWhenEmptyFrameIsReturned() throws GrabberService
      .GrabberServiceException {
    try {
      final GrabberService grabberService = createSimpleGrabberService(
          () -> new SimpleMockFrameGrabber() {
      ...
      fail("Should have thrown an exception when running one grab because the mat returned was "
          + "empty");
    } catch (GrabberService.GrabberServiceException e) {
      assertThat(e.getCause()).isNull();
      throw e;
  ...
  static class ConstructorThrowingFrameGrabber extends SimpleMockFrameGrabber {
    private static final String CONSTRUCTOR_EXCEPTION_MESSAGE = "This should be thrown when the "
