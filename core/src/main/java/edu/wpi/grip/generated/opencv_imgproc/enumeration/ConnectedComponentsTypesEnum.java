...
public enum ConnectedComponentsTypesEnum {
   ...
   * direction.
   */
  CC_STAT_LEFT(opencv_imgproc.CC_STAT_LEFT),
  /**
   * The topmost (y) coordinate which is the inclusive start of the bounding box in the vertical
   * direction.
   */
  CC_STAT_TOP(opencv_imgproc.CC_STAT_TOP),
  /**
   * The horizontal size of the bounding box
   */
  CC_STAT_WIDTH(opencv_imgproc.CC_STAT_WIDTH),
  /**
   * The vertical size of the bounding box
   */
  CC_STAT_HEIGHT(opencv_imgproc.CC_STAT_HEIGHT),
  /**
