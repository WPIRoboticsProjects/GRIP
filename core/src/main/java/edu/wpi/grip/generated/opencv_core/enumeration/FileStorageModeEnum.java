 ...
 *  returned by FileStorage::release) */
    ...
    FORMAT_YAML(opencv_core.FileStorage.FORMAT_YAML), /** flag, JSON format */
    FORMAT_JSON(opencv_core.FileStorage.FORMAT_JSON), /** flag, write rawdata in Base64 by default. (consider using WRITE_BASE64) */
    BASE64(opencv_core.FileStorage.BASE64), /** flag, enable both WRITE and BASE64 */
    WRITE_BASE64(opencv_core.FileStorage.WRITE_BASE64);
