...
public enum FileStorageModeEnum {
   ...
   */
  APPEND(FileStorage.APPEND),
  /**
   * flag, read data from source or write data to the internal buffer (which is returned by
   * FileStorage::release)
   */
  MEMORY(FileStorage.MEMORY),
  /**
   * mask for format flags
   */
  FORMAT_MASK(FileStorage.FORMAT_MASK),
  /**
   * flag, auto format
   */
  FORMAT_AUTO(FileStorage.FORMAT_AUTO),
  /**
   * flag, XML format
   */
  FORMAT_XML(FileStorage.FORMAT_XML),
  /**
   * flag, YAML format
   */
