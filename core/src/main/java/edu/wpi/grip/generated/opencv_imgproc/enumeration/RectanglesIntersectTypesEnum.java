...
public enum RectanglesIntersectTypesEnum {
    ...
    /** No intersection */
    INTERSECT_NONE(opencv_imgproc.INTERSECT_NONE), /** There is a partial intersection */
    INTERSECT_PARTIAL(opencv_imgproc.INTERSECT_PARTIAL), /** One of the rectangle is fully enclosed in the other */
