...
public enum HoughModesEnum {
   ...
   * \f$(\rho, \theta)\f$ , where \f$\rho\f$ is a distance between (0,0) point and the line, and
   * \f$\theta\f$ is the angle between x-axis and the normal to the line. Thus, the matrix must be
   * (the created sequence will be) of CV_32FC2 type
   */
   ...
   * starting and ending points, and the matrix must be (the created sequence will be) of the
   * CV_32SC4 type.
   */
