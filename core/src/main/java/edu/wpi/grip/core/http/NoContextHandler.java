...
/**
 * Jetty handler for all contexts that are not explicitly claimed by another handler. This will respond to HTTP requests
 * with a {@code 404 Not Found} error and HTML page.
 */
