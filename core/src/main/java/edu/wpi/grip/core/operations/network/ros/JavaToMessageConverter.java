...
public abstract class JavaToMessageConverter<J, M extends Message> {
    ...
    public static final JavaToMessageConverter<BlobsReport, grip_msgs.Blobs>
        BLOBS = new JavaToMessageConverter<BlobsReport, grip_msgs.Blobs>(grip_msgs.Blobs._TYPE) {
            @Override
            protected void doConvert(BlobsReport blobsReport, grip_msgs.Blobs blobsMsg, MessageFactory messageFactory) {
    ...
    public static final JavaToMessageConverter<LinesReport, grip_msgs.Lines>
        LINES = new JavaToMessageConverter<LinesReport, grip_msgs.Lines>(grip_msgs.Lines._TYPE) {
            @Override
            protected void doConvert(LinesReport linesReport, grip_msgs.Lines linesMsg, MessageFactory messageFactory) {
    ...
    public static final JavaToMessageConverter<ContoursReport, grip_msgs.Contours>
        CONTOURS = new JavaToMessageConverter<ContoursReport, grip_msgs.Contours>(grip_msgs.Contours._TYPE) {
            @Override
            void doConvert(ContoursReport contoursReport, grip_msgs.Contours contoursMsg, MessageFactory messageFactory) {
                ...
                final List<grip_msgs.Contour> contours = reportContours
                    .stream()
                    .map(contour -> {
                        final grip_msgs.Contour rosContour = messageFactory.newFromType(grip_msgs.Contour._TYPE);
    ...
    public static final JavaToMessageConverter<Boolean, std_msgs.Bool>
        BOOL = new SimpleConverter<Boolean, std_msgs.Bool>(std_msgs.Bool._TYPE, std_msgs.Bool::setData) {
        };

    public static final JavaToMessageConverter<Number, std_msgs.Float64>
        FLOAT = new SimpleConverter<Number, std_msgs.Float64>(std_msgs.Float64._TYPE, (msg, numb) -> msg.setData(numb.doubleValue())) {
        };

    private abstract static class SimpleConverter<J, M extends Message> extends JavaToMessageConverter<J, M> {
