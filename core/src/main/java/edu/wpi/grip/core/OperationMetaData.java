...
public class OperationMetaData {
   ...
   * @param operationSupplier a supplier for the {@code Operation}. This should return a new
   *                          instance each time it's called.
   */
  public OperationMetaData(OperationDescription description, Supplier<Operation>
      operationSupplier) {
  ...
  /**
   * Gets a {@code Supplier} for the operation. This should return a new instance each time it's
   * called.
   */
