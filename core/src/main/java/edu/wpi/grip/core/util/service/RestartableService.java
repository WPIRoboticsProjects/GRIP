...
/**
 * This interface defines a {@link Service} that breaks the guarantee that the {@link State#FAILED}
 * and {@link State#TERMINATED} states are terminal states. Instead, as long as the service is in a
 * non running state the service can be started.
 */
public interface RestartableService extends Service {
  ...
  /**
   * If the service state is {@link State#NEW}, {@link State#FAILED}, {@link State#TERMINATED} this
