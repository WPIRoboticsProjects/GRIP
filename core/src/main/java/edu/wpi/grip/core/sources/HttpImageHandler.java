...
/**
 * Jetty handler for incoming images to be used by {@link HttpSource}. Only one instance of this class
 * can exist for a context.
 * <p>
...
public final class HttpImageHandler extends PedanticHandler {
    ...
    /**
     * Removes the given callback from this handler. The callback will no longer be called when a new image is
     * POSTed to {@code /GRIP/upload/image}, unless it is re-added with {@link #addCallback(Consumer)}. Does nothing
