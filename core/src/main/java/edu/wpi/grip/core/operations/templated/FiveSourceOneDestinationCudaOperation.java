...
final class FiveSourceOneDestinationCudaOperation<T1, T2, T3, T4, T5, R> extends CudaOperation {
  ...
  public interface Performer<T1, T2, T3, T4, T5, R> {
    void perform(T1 src1, T2 src2, T3 src3, T4 src4, T5 src5, boolean preferCuda, R dst);
  }
