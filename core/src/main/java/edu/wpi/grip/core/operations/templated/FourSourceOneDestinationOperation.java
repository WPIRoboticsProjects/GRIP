...
final class FourSourceOneDestinationOperation<T1, T2, T3, T4, R> implements Operation {
  ...
  FourSourceOneDestinationOperation(
      ...
      SocketHint<T1> t1SocketHint, SocketHint<T2> t2SocketHint, SocketHint<T3> t3SocketHint,
      SocketHint<T4> t4SocketHint, SocketHint<R> rSocketHint, Performer<T1, T2, T3, T4, R>
          performer) {
  ...
  public FourSourceOneDestinationOperation(
      InputSocket.Factory inputSocketFactory,
      OutputSocket.Factory outputSocketFactory,
      Class<T1> t1, Class<T2> t2, Class<T3> t3, Class<T4> t4, Class<R> r, Performer<T1, T2, T3,
      T4, R> performer) {
    this(
        inputSocketFactory,
        outputSocketFactory,
