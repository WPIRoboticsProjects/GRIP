...
/**
 * Event for when a new operation is added to the application.  This happens, for example, if a user
 * loads a new Python script, or at startup for the built-in operations.  This is NOT the event for
