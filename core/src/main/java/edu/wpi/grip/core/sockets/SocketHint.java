...
public interface SocketHint<T> {
    ...
    /**
     * A SocketHintDecorator that easily redecorates the {@link #getIdentifier()}
     * method.
     *
    ...
    /**
     * @return The name for this socket
     */
    ...
    /**
     * @return The type of view that this hint reccomends being displayed with
     */
    View getView();
