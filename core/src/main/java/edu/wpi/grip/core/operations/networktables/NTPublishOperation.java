...
public class NTPublishOperation<T extends NTPublishable> implements Operation {
    ...
    /**
     * Change the server address according to the team number preference.  The NetworkTables server runs on the robot,
     * which as the hostname that looks like "roborio-frc-xxxx.local".
     */
    @Subscribe
