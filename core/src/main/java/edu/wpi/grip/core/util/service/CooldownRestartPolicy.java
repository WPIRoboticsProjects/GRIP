...
/**
 * Allows you to define a cooldown between failures. Defines whether or not the {@link
 * AutoRestartingService} should restart or not.
 *
...
public class CooldownRestartPolicy implements ServiceRestartPolicy {
  ...
  /**
   * @param interval How long to wait to restart
