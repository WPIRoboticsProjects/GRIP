...
public final class SocketHints {
  ...
  public static SocketHint<Boolean> createBooleanSocketHint(
      final String identifier,
  ...
  private static <T> SocketHint.Builder<T> createObjectSocketHintBuilder(
      final String identifier,
      final Class<T> type,
    ...
    if (withDefault) {
      return builder.initialValueSupplier(supplier);
    } else {
      return builder;
    }
  }
  ...
  private static SocketHint.Builder<Number> createNumberSocketHintBuilder(final String identifier,
                                                                          final Number number) {
    return new SocketHint.Builder<>(Number.class)
        .identifier(identifier).initialValue(checkNotNull(number, "Number can not be null"));
  }
  ...
  public static final class Inputs {
    ...
    public static SocketHint<Point> createPointSocketHint(final String identifier,
                                                          final boolean withDefault) {
      return createObjectSocketHintBuilder(identifier, Point.class, Point::new, withDefault)
          .build();
    }

    public static SocketHint<Point> createPointSocketHint(final String identifier, int x, int y) {
      return createObjectSocketHintBuilder(identifier, Point.class, () -> new Point(x, y), true)
          .build();
    }

    public static SocketHint<Number> createNumberSliderSocketHint(final String identifier,
                                                                  final Number number,
                                                                  final Number low,
                                                                  final Number high) {
      return createNumberSocketHintBuilder(identifier, number, new Number[]{low, high})
          .view(SocketHint.View.SLIDER).build();
    }

    public static SocketHint<Number> createNumberSpinnerSocketHint(final String identifier,
                                                                   final Number number,
                                                                   final Number low,
                                                                   final Number high) {
      return createNumberSocketHintBuilder(identifier, number, new Number[]{low, high})
          .view(SocketHint.View.TEXT).build();
    }
    ...
    public static SocketHint<String> createTextSocketHint(
        final String identifier,
        final String str) {
    ...
    public static SocketHint<Boolean> createCheckboxSocketHint(
        final String identifier,
        final Boolean initialValue) {
      return new SocketHint.Builder<>(Boolean.class)
          .identifier(identifier)
  ...
  public static final class Outputs {
    ...
    public static SocketHint<Boolean> createBooleanSocketHint(
      ...
      return new SocketHint.Builder<>(Boolean.class)
          .identifier(identifier).initialValue(defaultValue).build();
    }

    public static SocketHint<Number> createNumberSocketHint(final String identifier, Number
        defaultValue) {
