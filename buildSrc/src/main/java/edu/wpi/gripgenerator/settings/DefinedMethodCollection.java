...
public class DefinedMethodCollection {
  ...
  private final Map<DefinedParamType.DefinedParamDirection, Set<String>> directionDefault = new
      HashMap<>();
  ...
  public DefinedMethodCollection(String className, List<DefinedMethod> methodList) {
    ...
    this.definedMethodMap = methodList.stream().collect(Collectors.toMap
        (DefinedMethod::getMethodName, t -> t));
  }

  public DefinedMethodCollection setDirectionDefaults(DefinedParamType.DefinedParamDirection
                                                          direction, String... paramNames) {
  ...
  public Optional<DefinedParamType.DefinedParamDirection> getDefaultDirection(String check) {
    for (DefinedParamType.DefinedParamDirection direction : DefinedParamType
        .DefinedParamDirection.values()) {
  ...
  public void generateCompilationUnits(DefaultValueCollector collector, Map<String,
      CompilationUnit> compilationUnits, OperationList operations) {
