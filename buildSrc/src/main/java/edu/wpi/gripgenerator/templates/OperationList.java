...
/**
 * The template for the Operation List. This list contains all of the operations that have been
 * generated by the generator.
 */
public class OperationList {
  private static final String className = "CVOperations";
  private final PackageDeclaration packageDec = new PackageDeclaration(new NameExpr("edu.wpi.grip" +
      ".generated"));
  ...
  public OperationList(ImportDeclaration... imports) {
    ...
    this.imports.addAll(Arrays.asList(
        ...
        new ImportDeclaration(new NameExpr("edu.wpi.grip.core.events.OperationAddedEvent"),
            false, false)
    ));
