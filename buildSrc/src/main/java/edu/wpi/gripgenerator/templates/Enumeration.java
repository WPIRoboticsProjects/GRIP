...
public class Enumeration {
  ...
  public Enumeration(String name, PackageDeclaration packageDeclaration, String baseClassName,
                     String parentClassName, List<VariableDeclarator> declaratorList) {
    this.name = name;
  ...
  public PackageDeclaration getPackageDeclaration() {
    return new PackageDeclaration(new NameExpr("edu.wpi.grip.generated." + baseClassName + "" +
        ".enumeration"));
  }
  ...
  private List<ImportDeclaration> generateImports() {
    return Collections.singletonList(
        new ImportDeclaration(ASTHelper.createNameExpr(importExpression + baseClassName), false,
            false)
    );
  }
  ...
  /**
   * Uses the VariableDeclarator from the original source code to generate an equivalent constant in
   * the enumeration
   *
