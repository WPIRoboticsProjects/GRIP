...
/**
 * Helps create SocketHint declarations. For example: <code> SocketHintDeclaration testDeclaration =
 * new SocketHintDeclaration("Mat", Arrays.asList("src1", "src2")); testDeclaration
 * .getDeclaration().toString() </code> will generate <code> private final SocketHint&lt;Mat&gt;
 * src1Hint = new SocketHint&lt;Mat&gt;("src1", Mat.class), src2Hint = new
 * SocketHint&lt;Mat&gt;("src2", Mat.class); </code>
 */
