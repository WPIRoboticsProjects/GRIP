...
public abstract class DefaultValue {
   ...
   *
   * @param defaultValue The helper default value to define the exact expression to return. For
   *                     example, with enums this will be the enumeration declaration name that is
   *                     the default.
