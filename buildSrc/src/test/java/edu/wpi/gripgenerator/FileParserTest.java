...
public class FileParserTest {
  ...
  public void testReplaceRegexParamAtEnd() {
    ...
    String replacedMethod = testMethod.replaceAll(FileParser.methodReorderPattern, FileParser
        .methodNewOrder);
    assertEquals("Result was not the expected string after regex replacement", result,
        replacedMethod);
  }
  ...
  public void testSimpleRearrange() {
    ...
    String replacedMethod = testString.replaceAll(FileParser.methodReorderPattern, FileParser
        .methodNewOrder);
    assertEquals("Result was not the expected string after regex replacement", expectedResult,
        replacedMethod);
  }
